...
peer-reviewed journals in English (about 1.2 million articles), we restrict our
sample to articles with at maximum 15 authors, which constitute 99.95% of the
data set. For each article, we extracted in our initial data base all authors'
